...
# MoneyG Finance App用 GitHub ラベル設定スクリプト
# このスクリプトを実行してプロジェクト管理用ラベルを一括作成

echo "🏷️ MoneyG Finance App用 GitHub ラベルを作成中..."
...
echo "✅ すべてのラベルが正常に作成されました！"
echo ""
echo "🔄 次のステップ:"
echo "1. 既存issueに新しいラベルを追加"
echo "2. GitHub Projectボードを作成"
echo "3. 自動化ルールを設定"
echo ""
echo "📋 既存issueを更新するには以下を実行:"
