        ...
        children: [
          ...
          _buildSection(
            ...
            [
              ...
              _buildFaqItem(
                'カテゴリは変更できますか？',
                'はい、カスタムカテゴリ機能が利用できます。設定画面から「カスタムカテゴリ管理」を選択して、独自のカテゴリを作成・編集・削除できます。カテゴリごとに名前、色、アイコンをカスタマイズして、あなたの支出管理をより便利にしましょう。',
              ),
              _buildFaqItem(
                '通知が来ないのですが？',
              ...
              _buildFaqItem(
                'カスタムカテゴリを削除したらデータはどうなりますか？',
                'カスタムカテゴリを削除すると、そのカテゴリを使用していた支出・収入データは「削除されたカテゴリ」として表示されます。データ自体は保持されるため、統計や履歴は引き続き確認できます。',
              ),
              _buildFaqItem(
                'データを間違って削除してしまいました',
